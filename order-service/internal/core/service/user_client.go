...
func GetUser(ctx context.Context, userId primitive.ObjectID) (exists bool, cerr domain.CError) {
	...
	_, err = grpcClient.Get(context.Background(), &user.UserRequest{UserId: userId.Hex()})
	if err != nil {
